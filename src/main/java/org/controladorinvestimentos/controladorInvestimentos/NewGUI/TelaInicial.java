...
public class TelaInicial extends Application {
    ...
    /*
        if (!inicializado) {
            ...
            controladorUsuario.cadastrarNovoUsuario(123, "teste", "mail", "123");
            usuarioTeste = new Usuario(123, "teste", "mail", "123");
            ...
            // Associar a carteira ao repositório do usuário
            usuarioTeste.getRepositorioCarteira().adicionarCarteira(carteiraTeste);
